...
-- Register employees
INSERT INTO employees(ID, DATE_OF_ACCEPTANCE, END_OF_EMPLOYMENT_CONTRACT, BANK_ACCOUNT, PERMISSIONS) VALUES (10000, DATE'2015-08-01', DATE'2016-08-01', 'Some bank info', 1);
INSERT INTO employees(ID, DATE_OF_ACCEPTANCE, BANK_ACCOUNT, PERMISSIONS) VALUES (10001, DATE'2017-11-05', 'Some bank info2', 1);
INSERT INTO employees(ID, DATE_OF_ACCEPTANCE, BANK_ACCOUNT, PERMISSIONS) VALUES (10004, DATE'2011-01-11', 'Some bank info3', 5);

-- Create carrier borrow records
INSERT INTO carrier_borrow_records(BORROW_DATE, EXPECTED_RETURN_DATE, BORROWER_ID, CREATED_BY_ID) VALUES (DATE'2017-07-02', DATE'2017-07-09', 10002, 10004);
INSERT INTO carrier_borrow_records(BORROW_DATE, EXPECTED_RETURN_DATE, BORROWER_ID, CREATED_BY_ID, ACTUAL_RETURN_DATE, ACCEPTED_BY_ID) VALUES (DATE'2013-03-11', DATE'2013-03-25', 10005, 10000, DATE'2013-04-17', 10001);
